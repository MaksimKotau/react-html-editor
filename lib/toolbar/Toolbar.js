...
const Toolbar = () => {
    return (react_1.default.createElement("div", { id: "htmleditor_toolbar" }, buttons.map((el, index) => (react_1.default.createElement(ToolbarButton_1.default, { key: `HTML_Editor_Button_${index}`, element: el.element })))));
};
