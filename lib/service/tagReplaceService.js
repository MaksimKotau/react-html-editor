...
class ArticleDOMNode extends react_1.Component {
    ...
    render() {
        return (react_1.default.createElement("article", { style: { border: this.props.readonly ? undefined : "1px solid #999" }, ref: (elem) => this.articleRef = elem, suppressContentEditableWarning: true, contentEditable: !this.props.readonly, key: 'article_editor' },
