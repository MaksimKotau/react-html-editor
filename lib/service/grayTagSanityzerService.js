        ...
        for (let i = 0; i < attributes.length; i++) {
            ...
            if (currentItem !== null) {
                ...
                if (foundGrayConfig) {
                    ...
                    if (foundAttr) {
                        foundJSXParams = Object.assign({}, foundJSXParams, exports.getGrayAttrForJSX(currentItem, foundGrayConfig));
                    }
                }
            }
        }
        foundJSXParams = Object.assign({}, foundJSXParams, attributesConverterService_1.convertAllAttributes(attributes));
    }
